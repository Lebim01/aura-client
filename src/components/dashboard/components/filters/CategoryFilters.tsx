...
const options = [
  ...
  },
  {
    ...
    img: "/categories/cienciaficcion.jpg",
    style: {
      background:
  ...
  },
  {
    ...
    img: "/categories/documentales.jpg",
    style: {
